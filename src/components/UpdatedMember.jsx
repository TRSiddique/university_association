...
const UpdatedMember = () => {
  ...
  const uploadImageToServer = async (file) => {
    ...
    try {
      const response = await fetch('university-association-backend-1.onrender.com/upload', {
        method: 'POST',
        body: formData,
      });
  ...
  const handleUpdateMember = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`university-association-backend-1.onrender.com/member/${_id}`, {
        method: 'PUT',
        headers: {
